...
//        error_log('###### antes ' . $sql . ' ######### ,' . $codiTRDS . ',' . $codiTRD . ',' . $noRadicado . ',' . $coddepe . ',' . $codusuario);
        if ($rs->RowCount() >= 1) {
...
//            error_log(' ### ' . count($codiTRDS) . ' ### $noRadicado ' . $noRadicado . ' ### $coddepe ' . $coddepe . ' ### ' . $codusuario . ' ### ' . $usDoc . '### ' . $codiTRD);
            if (count($codiTRDS) > 1) {
