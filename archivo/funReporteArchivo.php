...
function pintarEstadistica($fila, $indice, $numColumna) {
    ...
    switch ($numColumna) {
        ...
        case 2:
            ...
            $salida = "<a href=\"../estadisticas/genEstadistica.php?{$datosEnvioDetalle}\"  target=\"detallesSec\" aria-label=\"Abrir el reporte detallado de los radicados encontrados para este usuario\" >" . $radicados . "</a>";
            break;
    ...
    switch ($numColumna) {
        case 0:
            ...
            if ($hidradipath && $verImg)
                $salida = "<center><a href=\"{$dir_raiz}bodega" . $hidradipath . "\" aria-label=\"Abrir Documentos del radicado\">" . $radicados . "</a></center>";
            else
        ...
        case 1:
            if ($_GET['arch'] != 1) {
                if ($verImg) {
                    $salida = "<a class=\"vinculos\" href=\"{$dir_raiz}verradicado.php?verrad=" . $radicados . "&amp;" . session_name() . "=" . session_id() . "&amp;carpeta=8&amp;nomcarpeta=Busquedas&amp;tipo_carp=0 \" aria-label=\"Abrir informaci�n del radicado\" >" . $fecharadica . "</a>";
                } else {
