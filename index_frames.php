            ...
            function frameLoad() {
                ...
                if (check.visible === true) {
                    ...
                    ***/
                    ...
                    Autor: Andrés Mosquera
                    Fecha: 06-11-2018
                    Información: Fin Se agrega display: block para mostrar la barra flotante de transacciones
                    ***/
                    ...
                    ***/
                    ...
                    Autor: Andrés Mosquera
                    Fecha: 06-11-2018
                    Información: Fin Se agrega display: none para ocultar la barra flotante de transacciones
                    ***/
                }
                    ...
                    <nav id="menu">
                        <form name=form_cerrar action=cerrar_session.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah" ?> target=_parent method=post>
                            <ul>
                                ...
                                ?>
                                    <li><a href="./estadisticas/vistaFormConsulta.php?<?= session_name() . "=" . trim(session_id()) . "&fechah=$fechah" ?>" target="mainFrame"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span></a><p>Estad&iacute;sticas</p></li>
        ...
        <div id="bottomMenu" class="bot" style="visibility: hidden;">
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="#" onclick="contentMainFrame.changedepesel(61);contentMainFrame.seleccionBarra = 61;">
                            <img src="estilos/orfeo50/imagenes50/TRD_1.png" class="aplicarTrd" alt="Aplicar TRD" />
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#" id="NRR" onclick="contentMainFrame.changedepesel(16);contentMainFrame.seleccionBarra = 16;">
                            <img src="estilos/orfeo50/imagenes50/propuesta_3_nrr.png" alt="No requiere respuesta" style="width: 29px; height: 29px; margin-top: -3px;" />
                        </a>
                    </li>
