...
$nivelRad = $assoc == 0 ? $rs->fields["nivel_seguridad"] : $rs->fields["NIVEL_SEGURIDAD"];
...
//        echo '--------- '.$serie_nombre.' -------- '.$subserie_nombre.' ------- '.$tpdoc_nombreTRD. ' linea 297';
    } else {
...
//        echo '--------- '.$serie_nombre.' -------- '.$subserie_nombre.' ------- '.$tpdoc_nombreTRD. ' linea 335 ';
    }
...
//    echo '--------- '.$serie_nombre.' -------- '.$subserie_nombre.' ------- '.$tpdoc_nombreTRD;
