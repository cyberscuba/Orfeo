...
function print_table($dir, $list, $allow) {    // print table of files
    ...
    while(list($item,) = each($list)){
        ...
        if(is_dir($abs_item)) {
        //**Modificaciòn Skina, se agrega y cambia codificaciòn de nombre**//
        //**de archivos y su path, para soportar nnombres de plantillas  **//
        //**o archivos con tildes                     **//
        //**Ing Camilo Pintor - cpintor@skinatech.como            **//
        //**Skinatech ltda                             **//
        //**MAYO 2015                                **//
            $link = make_link("list",get_rel_item($dir, $item),NULL);
            //Se agrega utf8 - Skina
    ...
    // Icon + Link
        ...
        //Se comenta y cambia por utf8 - Skina
        //echo htmlspecialchars($s_item)."</A></TD>\n";    // ...$extra...
        echo utf8_decode($s_item)."</A></TD>\n";    // ...$extra...
        //** Fin Modificaciòn Skina, se agrega y cambia codificaciòn de nombre**//
    // Size
