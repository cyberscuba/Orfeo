...
$titulo = htmlentities("Cierre de sesión - ORFEO 5", 0, 'UTF-8');
...
<html>
    ...
    <center>
        <div class="flotante">
            <img border="0" src="estilos/orfeo50/imagenes50/logoEntidad.png" alt='Volver al formulario de inicio de sesion' style="width: 28%;">
