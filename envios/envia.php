...
//            error_log('--------------- '.$rsEnvio->fields["VALOR1"].' --------'.$rsEnvio->fields["VALOR2"]);
    ...
    ?>
        ...
        {
            alert('Rango y peso especificado no está configurado,\nComuníquese con el administrador del sistema.' + document.forma.elements['empresa_envio'].value + '--- ' + document.getElementById('envio_peso').value + ' ---- ' + document.getElementById('envio_peso').value);
        }
        }}
    <?php
} else
