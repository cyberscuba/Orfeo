...
define("LOCAL_STORAGE_DIR", 'logs/');
define("LOG_FILE_NAME", 'application_' . date('m-d-y') . '.txt');  // The name of the log file
...
class PHPLogger {
     ...
     * @static
     *
     * @return an instance of the PHPLogger object
     */
