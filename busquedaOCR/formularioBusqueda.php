                    ...
                    "columns": [
                        ...
                        {data: 'data2',
                            render: function (data2, type) {
                                var dateSplit = data2.fechaRad.split(' ');
                        ...
                        {data: 'data2',
                            render: function (data2) {
                                ...
                                if (data2.tipoDoc === "2") {
                                    ruta = "/bodega/" + fecha + "/" + data2.depeRadi + "/docs/" + numeroRad + "_A" + anexCodi + ".pdf";
                                    return "<a href='../verradicado.php?verrad=" + data2.padreRad + "&menu_ver_tmp=2&rutaAnexo="+ruta+"' target='_blank' >" + data2.num + '</a>';
                                } else if (data2.tipoDoc === "1") {
                                    return "<a href='../verradicado.php?verrad=" + data2.num + "&menu_ver=6' target='_blank' >" + data2.num + '</a>';
                                }
                            }
                        },
                        {data: 'data2',
