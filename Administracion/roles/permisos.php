...
<!--            <tr>
            ...
            <table border=1 width=100% class=borde_tab>
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2">
                        ...
                        ?>
                        <input type="checkbox" name="prestamo" <?php echo $check ?>> Pr&eacute;stamo de documentos.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    ...
                    if ($usua_perm_avaz == 1) {
                        ...
                        <td height='26' width='30%' class='listado2'>
                            ...
                            ?>
                            <input type="checkbox" name="autenticaLDAP" <?php echo $check ?>> Ingresar por directorio activo.
                            <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    <td height='26' width='30%' class='listado2'>
                        ...
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                              title="Permite la tipificaci&oacute;n de los anexos digitalizados en la pesta&ntilde;a documentos del sistema. Por defecto, el sistema le asigna este permiso a los usuarios con permiso de digitalizaci&oacute;n." style="margin-left: 50%;"></span>
                    </td>
                    <td width="30%" height="26" class="listado2">
                        <?php
                        ...
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                              ...
                              0 - No tiene permiso asignado.
                              1 - Tiene el permiso para radicar comunicaciones por correo electr&oacute;nico." style="margin-left: 50%;"></span>
                    </td>
                    <td width="30%" height="26" class="listado2"> 
                        <?php
                        if ($env_correo == 'on') {
                ...
                <tr>
                    ...
                    <td height='26' width='30%' class='listado2'>
                        ...
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                              title="title="Permite realizar la descarga de los archivo .pdf que se cargan en el sistema"" style="margin-left: 45%;"></span>
                    </td>
                </tr>
            </table>
            ...
            if (isset($_POST['guardar'])) {
                ...
                if ($rssqlselect->fields["NOMB_PERFIL"] == '') {
                    ...
                    $isql_final = " usua_perm_preradicado  = $preRadica where codi_perfil =" . $_POST['codrol'];
                ...
                echo '<div style="margin-top: -48%; position: absolute; margin-left: 28%; font-weight: bold;">';
                echo $mensaje_err;
                echo '</div>';
            }
            ?>
