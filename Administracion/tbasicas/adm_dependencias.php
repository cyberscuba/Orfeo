...
//                    $record['REG_CODI'] = $_POST['regional'];
                        ...
                        if ($_POST['slc_tr' . $tmp1]) {
                            ...
                            switch ($db->driver) {
                                case 'oci8':
                                    ...
                                    $sql_rtp = "select * from radicado where " . $db->conn->substr . '(radi_nume_radi,18,1)=' . $tmp1 . " and radi_depe_radi=" . $_POST['txtIdDep'];
                                    break;
                                case 'mssql':
                                ...
                                default:
                                    ...
                                    $sql_rtp = "select * from radicado where " . $db->conn->substr . '(radi_nume_radi,18,1)=' . "'$tmp1'" . " and radi_depe_radi='" . $_POST['slc_tr' . $tmp1] . "'";
                                    break;
                            }
                            $ADODB_COUNTRECS = true;
...
?>
            ...
            function ValidarInformacion(accion)
            {
                if ((accion == 'Agregar') || (accion == 'Modificar'))
                {
                    ...
                    {
                        alert('Seleccione un Pa&iacute;s');
                ...
                if (accion == 'Agregar')
                {
                    for (n = 1; n < document.formSeleccion.id.length; n++)
                        if (document.formSeleccion.id.options[n].value == document.formSeleccion.txtIdDep.value) {
                            alert('!Ya existe una dependencia con este c&oacute;digo!');
                            return false;
                        }
                }
                if (accion == 'Eliminar')
