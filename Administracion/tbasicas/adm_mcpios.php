...
if ($error){	
    ...
    switch ($error){	
        ...
        case 5: echo "No se puede eliminar municipio, se encuentra ligado a direcciones. !!";break;
        case 6: echo "Error: El indicativo del municipio que intenta crear ya existe. !!";break;
        case 7: echo "Error: El municipio que intenta crear ya existe. !!";break;
        case 8: echo "Se elimino de forma correcta el municipio. !!";break;
    }
    echo '</td></tr>';
}
?>
