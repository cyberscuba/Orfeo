            ...
            <table border=1 width=93% class=t_bordeGris align="center">
                ...
                if ($usModo == 2) { //modo editar
                    if ($valRadio) {
                        ...
                        $q_ah = "select * from anexos_historico where usua_doc='$usuDocSel' limit 1000";
                        $rs_ah = $db->query($q_ah);
                ...
                <?php if ($usModo == 1) { ?>
                    ...
                    <td class="listado2" width="15%" height="1">
                        <input type=text name=usuLogin id=usuLogin value='<?= $usuLogin ?>' title='Login con el que se va a ingresar al sistema' maxlength="20" style='width: 96%;' zrequired="">
                    </td>
                <?php } else { ?>
                    <td class="listado2" width="13%"><label for="cedula">N&uacute;mero C&eacute;dula <font color="red">*</font></label> </td>
                    <td class="listado2" width="22%" height="1">
                    ...
                    <td class="listado2" width="13%"><label for="usuLogin">Usuario <font color="red">*</font></label> </td>
                    <td class="listado2" width="15%" height="1">
                        <input  type="text" name="usuLogin"  id="usuLogin"  value='<?= $usuLogin ?>' <?= $ronly_log ?>  maxlength="20" style='width: 96%;' required="">
                    </td>
                <?php }
                ?>
