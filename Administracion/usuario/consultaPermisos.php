            ...
            <table width="90%" border="1" cellpadding="0" cellspacing="5" >
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2"> <!--input type="checkbox" name="adm_archivo" value="$adm_archivo" <?php
                        ...
                        $contador = 0;
                        while ($contador <= 2) {
                            echo "<input name='adm_archivo' disabled='' type='radio' value=$contador ";
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2"> 
                        <input type="checkbox" disabled='' name="dev_correo" value="$dev_correo" <?php
                        if ($dev_correo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td width="30%" height="26" class="listado2">
                        <input type="checkbox" name="masiva" disabled='' value="$masiva" <?php
                        if ($masiva)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td width="30%" height="26" class="listado2"> Impresi&oacute;n
                        ...
                        $contador = 0;
                        while ($contador <= 2) {
                            echo "<input name='impresion' disabled='' type='radio' value=$contador ";
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2">
                        <input type="checkbox" name="prestamo" disabled='' value="$prestamo" <?php
                        if ($prestamo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    ...
                    if ($usua_perm_avaz == 1) {
                        ?>
                        <td height='26' width='30%' class='listado2'>
                            <input type="checkbox" disabled='' name="autenticaLDAP" value="$autenticaLDAP" <?php
                            if ($autenticaLDAP)
                                echo "checked";
                            else
                                echo "";
                ...
                <tr>
                    <td height='26' width='30%' class='listado2'>
                        <input type="checkbox" name="permTipificaAnexos" disabled='' value="$permTipificaAnexos" <?php
                        ...
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                              title="Permite la tipificaci&oacute;n de los anexos digitalizados en la pesta&ntilde;a documentos del sistema. Por defecto, el sistema le asigna este permiso a los usuarios con permiso de digitalizaci&oacute;n." style="margin-left: 54%;"></span>
                    </td>
                    <td width="30%" height="26" class="listado2">
                        ...
                        $contador = 0;
                        while ($contador <= 1) {
                            echo "<input name='usuaPermRadEmail' disabled='' type='radio' value=$contador ";
                        ...
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                              ...
                              0 - No tiene permiso asignado.
                              1 - Tiene el permiso para radicar comunicaciones por correo electr&oacute;nico." style="margin-left: 53%;"></span>
                    </td>
                    <td width="30%" height="26" class="listado2"> 
                        <input type="checkbox" disabled='' name="env_correo" value="$env_correo" <?php
                        if ($env_correo)
                            echo "checked";
                        else
                            echo "";
                ...
                <tr>
                    <td height='26' width='30%' class='listado2'>
                        <input type="checkbox" disabled='' name="permBorraAnexos" value="$permBorraAnexos" <?php
                        if ($permBorraAnexos)
                            echo "checked";
                        else
                            echo "";
                    ...
                    <td width="30%" height="26" class="listado2"> 
                        <input type="checkbox" disabled='' name="adm_sistema" value="$adm_sistema" <?php
                        if ($adm_sistema)
                            echo "checked";
                        else
                            echo "";
