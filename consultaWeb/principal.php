...
<div id="container2">
      ...
      <div class="info">
           <center> <img src="../logoEntidad.png"  height="20%" align="center"/></center>
            ...
            <input type="button" name="Submit" value="Cerrar" onclick="window.location = 'http://192.168.14.10/consultaWeb/'; window.close();" />
      </div>
<div class="datagrid">
      <ul>
      <div id="foli3">
            <table width="100%" summary="Contiene la información de su solicitud">
                  ...
                  <tbody>
                        <tr>
                              ...
                              <td><?=$cuentai?>-</td>
                        <? if(!$flujo_nombre and $radi_depe_actu=='0999') $flujo_nombre = "Finalizado";
            ...
            <table width="100%" summary="Detalle de los documentos que han sido anexados a la solicito.">
                  ...
                  if(!$rss->EOF){?>
                        ...
                        <? while(!$rss->EOF){
                              ...
                              if ($long>15){ $radEnviado=substr($anex_codigo, 0, 15); }
