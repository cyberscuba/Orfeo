...
$sql="SELECT USUA_EMAIL FROM USUARIO WHERE USUA_CODI=$usua AND DEPE_CODI='$depe'";
$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
$rs=$db->conn->query($sql);
...
else
{
    ...
    $mail->Subject    = "El documento con el radicado ".$radi." , ha sido entregado";
    ...
    $mensaje = "<html>
        ...
        ".$entidad." , ".$fecha." <br>
        <br></br>
        El documento con el número de radicado ".$radi." , ha sido entregado y formalizado con el sello del destinatario, ya se encuentra en el sistema y el documento físico lo tiene el centro documental. <br><br>";

         $mensaje .=  'Para acceder al radicado <a href="http://190.131.237.28/pruebas/verradicado.php?verrad='.$radi.'"> '.$radi.' </a>';
