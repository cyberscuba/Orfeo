...
//                error_log('@@@@@@@@@@@ '.$insertSQL.' @@@@@ '. print_r($record));
            }
            return ($radicados);
        }
    }
...
//        error_log('-- '.$numeroExpediente.', '.$radicados.', '.$dependencia.', '.$codUsuario.', '.$observacion.', '.$tipoTx.', '.$codigoFldExp);
        //Arreglo que almacena los nombres de columna
        #==========================
        # Busca el Documento del usuario Origen
        $ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
        ...
        if ($radicados) {
            foreach ($radicados as $noRadicado) {
                ...
                error_log('--'.$numeroExpediente.' -- '.$codigoFldExp.' -- '.$noRadicado.' -- '.$dependencia.' -- '.$codUsuario. ' -- '.$usDoc.' -- '.$tipoTx.' -- '.$observacion);
