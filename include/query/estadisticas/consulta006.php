...
switch ($db->driver) {
    ...
    case 'postgres': {
			...
			WHERE
				...
				GROUP BY b.USUA_NOMB, d.DEPE_NOMB, d.DEPE_CODI
			ORDER BY $orno $ascdesc";
            } else {
                $queryE = "SELECT b.USUA_NOMB AS USUARIO, b.DEPE_CODI AS HID_DEPE_USUA,
                                count($radi_nume_radi) AS RADICADOS, 
...
if (isset($_GET['genDetalle']) && $_GET['denDetalle'] = 1) {
    ...
    $titulos = ($tipoDocumento == '9999') ? array("#", "1#Usuario", "2#Dependencia","3#Radicados") : array("#", "1#Usuario", "2#Tipo documento", "3#Radicados");
}
    ...
    switch ($numColumna) {
        ...
        case 2:
            if (isset($dependenciaNom)) {
                ...
                $datosEnvioDetalle = "tipoEstadistica=" . $_POST['tipoEstadistica'] . "&amp;genDetalle=1&amp;usua_docs=" . $hiddocusuario . "&amp;dependencia_busq=" . $dependeciaUser . "&amp;fecha_ini=" . $_POST['fecha_ini'] . "&amp;fecha_fin=" . $_POST['fecha_fin'] . "&amp;tipoRadicado=" . $_POST['tipoRadicado'] . "&amp;tipoDocumento=" . $_POST['tipoDocumento'] . "&amp;codUs=" . $hidcodusuario . "&amp;";
        ...
        case 3:
            ...
            $datosEnvioDetalle = "tipoEstadistica=" . $_POST['tipoEstadistica'] . "&amp;genDetalle=1&amp;usua_docs=" . $hiddocusuario. "&amp;dependencia_busq=" . $dependeciaUser . "&amp;fecha_ini=" . $_POST['fecha_ini'] . "&amp;fecha_fin=" . $_POST['fecha_fin'] . "&amp;tipoRadicado=" . $_POST['tipoRadicado'] . "&amp;tipoDocumento=" . $_POST['tipoDocumento'] . "&amp;codUs=" . $hidcodusuario . "&amp;tipoDOCumento=" . $hidtprcodigo;
            $datosEnvioDetalle = (isset($_POST['usActivos'])) ? $datosEnvioDetalle . "&amp;usActivos=" . $_POST['usActivos'] : $datosEnvioDetalle;
            $salida = "<a href=\"genEstadistica.php?{$datosEnvioDetalle}&amp;krd={$krd}\"  target=\"detallesSec\" >" . $radicados . "</a>";
            break;
    }
    ...
    switch ($numColumna) {
        ...
        case 1:
            if ($fila['HID_RADI_PATH'] && $verImg)
                $salida = "<center><a href=\"{$ruta_raiz}bodega" . $fila['HID_RADI_PATH'] . "\">" . $radicado . "</a></center>";
            else
                $salida = "<center class=\"leidos\">{$radicado}</center>";
            break;
        case 2:
            if ($verImg)
                $salida = "<center><a class=\"vinculos\" href=\"{$ruta_raiz}verradicado.php?verrad=" . $radicado . "&amp;" . session_name() . "=" . session_id() . "&amp;krd=" . $_GET['krd'] . "&amp;carpeta=8&amp;nomcarpeta=Busquedas&amp;tipo_carp=0 \" >" . $fechaRadicacion . "</a></center>";
            else
