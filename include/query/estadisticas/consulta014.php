...
function pintarEstadistica($fila, $indice, $numColumna) {
    ...
    switch ($numColumna) {
        ...
        case 1:
            ...
            break;
        case 2:
            $datosEnvioDetalle = "tipoEstadistica=" . $_POST['tipoEstadistica'] . "&amp;genDetalle=1&amp;usua_docs=" . urlencode($fila['HID_USUA_DOC']) . "&amp;dependencia_busq=" . $usuarioDep . "&amp;fecha_ini=" . $_POST['fecha_ini'] . "&amp;fecha_fin=" . $_POST['fecha_fin'] . "&amp;tipoRadicado=" . $_POST['tipoRadicado'] . "&amp;tipoDocumento=" . $_POST['tipoDocumento'] . "&amp;codUs=" . $hidCodUsu . "&amp;depeUs=" . $fila['HID_DEPE_USUA'];
    ...
    switch ($numColumna) {
        ...
        case 1:
            if ($hidRadiPath && $verImg)
                $salida = "<center><a href=\"{$url_raiz}bodega/" . $hidRadiPath . "\">" . $radicado . "</a></center>";
            else
                $salida = "<center class=\"leidos\">". $radicado ."</center>";
            break;
        case 2:
            if ($verImg)
                $salida = "<a class=\"vinculos\" href=\"{$url_raiz}verradicado.php?verrad=" . $radicado . "&amp;" . session_name() . "=" . session_id() . "&amp;krd=" . $_SESSION['krd'] . "&amp;carpeta=8&amp;nomcarpeta=Busquedas&amp;tipo_carp=0 \" >" . $fechaRadicacion . "</a>";
            else
