...
$dependenciaSel = $_POST['dependenciaSel'];
$nume_expe = $_POST['nume_expe'];
...
//-->
    ...
    <!--                                    <tr>
                                        ...
                                        <tr>
                                            <td class="titulos2"><label for="fecha_ini">Fecha inicial (a&ntilde;o/mes/d&iacute;a)</label></td>
                                            <td class="listado2">
                                                <script language="javascript">
                                        ...
                                        <tr>
                                            <td class="titulos2"><label for="fecha_fin">Fecha final (a&ntilde;o/mes/d&iacute;a)</label></td>
                                            <td class="listado2">
                                                <script language="javascript">
