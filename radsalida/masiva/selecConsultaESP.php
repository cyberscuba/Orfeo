...
//                echo "<br>-----> select linea 77 ".$seleccNuevacct;
        }
    }
    next($check_value);
    $i++;
...
//echo "<br>-----> select seleccNueva despues " . $seleccNueva . ' -----> ' . $seleccNuevacct;
...
if ($selectedForm) {
//    echo "<br>-----> select inicial selectedForm " . $selectedForm;
...
//    echo "<br><pre> -----> arrSelGlobal ";
//    print_r($arrSelGlobal);
//    echo "</pre>";
