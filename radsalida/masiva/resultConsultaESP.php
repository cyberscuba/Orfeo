...
switch ($_POST['slc_tb']) {
    case '0': { //Si incluy� alguna cadena a buscar
            if (strlen($nombre))
                $sqlWhere .= " (nombre_de_la_empresa like '%$nombre%' or sigla_de_la_empresa like '%$nombre%') and ";
    ...
    case '1': { //Si incluy� alguna cadena a buscar
            if (strlen($nombre))
                $sqlWhere .= " (SGD_OEM_OEMPRESA like '%$nombre%' or SGD_OEM_SIGLA like '%$nombre%') and ";
            //Si se desea realizar la b�squeda por continente
            if ($_POST['idcont1'] != 0)
                $sqlWhere .= "ID_CONT = " . $_POST['idcont1'] . " and ";
            //Si se desea realizar la b�squeda por pais
    ...
    case '2': { //Si incluy� alguna cadena a buscar
            if (strlen($nombre))
                $sqlWhere .= " (SGD_CIU_NOMBRE like '%$nombre%' or SGD_CIU_APELL1 like '%$nombre%') and ";
            //Si se desea realizar la b�squeda por continente
            if ($_POST['idcont1'] != 0)
                $sqlWhere .= "ID_CONT = " . $_POST['idcont1'] . " and ";
            //Si se desea realizar la b�squeda por pais
