...
if ($salida == "pdf") {
    ...
    //echo '--> '.$archivo.' - '.$selected0.' - '.$selectedctt0.' - '.$selected1.' - '.$selected2.' - '.$selectedctt1.' - '.$selectedctt2;
//    $genera = $esp->generarCSV($archivo, $selected0, $selectedctt0, $selected1, $selected2, $selectedctt1, $selectedctt2);
