...
// Solicita confirmación para excluir el radicado del expediente
                ...
                <table border=0 width="93%" align="center" class="borde_tab">
                    ...
                    <center><input name="cerrar" type="button" class="botones_funcion" id="envia22" onClick="opener.regresar();
                                window.close();" aria-label="Cerrar ventana" value=" Cerrar "></center></TD>
                    </tr>
                </table>
                <?php
            }
