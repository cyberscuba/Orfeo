    ...
    <body id="public">
        <div id="container">
            ...
            <form id="contactoOrfeo" class="wufoo topLabel" enctype="multipart/form-data" method="post" action="formulariotx.php" name="quejas" onsubmit="return validarForm(this);">
                <div class="info">
                    <center> <img src="../logoEntidad.png"  height="100px" align="center"/></center>
                    <p><br> <h3>PQRS - Información</h3>
                            &nbsp </br>ESTAMOS COMPROMETIDOS CON LA CALIDAD y su satisfacción o insatisfacción por nuestros servicios.</br>Para presentar una solicitud de información, Petición, Queja, Reclamo o Sugerencia diligenciar el formulario, tenga en cuenta lo siguiente: </b></br></br>En cualquier caso su requerimiento puede realizarse de manera anónima o identificada. Si usted opta por presentar su comunicación en forma anónima, no será posible que reciba de manera directa respuesta por parte de esta entidad. Los campos con (<font color="#FF0000">*</font>) son obligatorios. </br></br>
                        <h3>Si usted desea registrar una PQR's de forma anonima, escriba el Número de identificación 111111111 y el sistema cargara automaticamente la información</h3>
                    </p>
                </div>
                <fieldset>
                ...
                <fieldset>
                    ...
                    <div id="datosSolicitud">
                        <div id="li_tipoSolicitud">
                            <label class="desc" id="title_grupoInteres" for="grupoInteres">Tipos de usuarios o grupos de interés<font color="#FF0000">*</font></label>
