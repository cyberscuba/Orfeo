...
$ldapServer = '10.15.128.21'; //Nombre o IP del servidor de autenticacion LDAP
$cadenaBusqLDAP = 'CN=srv.orfeo,OU=Bogota,OU=Colombia,OU=Construction,OU=Services_OHL,DC=ohl,DC=es'; //Cadena de busqueda en el servidor.
