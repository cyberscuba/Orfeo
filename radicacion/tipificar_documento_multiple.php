	...
	if ($radiNumero !=''){
		...
		$mensaje_err = "<HR>
		   <center><B><FONT COLOR=RED>
            ...
            switch ($db->driver) {
                case 'mysql':
                    $dato = 'cast(radi_nume_radi as char(15))';
                break;
                default:
                    $dato = 'cast(radi_nume_radi as varchar(15))';
                break;
            }
            $sqlH = "SELECT $dato as RADI_NUME_RADI FROM SGD_RDF_RETDOCF b  WHERE SGD_MRD_CODIGO =  '$codiTRD'". $whereFiltro;
