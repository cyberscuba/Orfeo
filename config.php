...
$servidor = "127.0.0.1:5432";          // Nombre o IP del srv de BD. Opcional puerto, 120.0.0.1:1521
$servicio = "orfeodb55";               // Nombre de la base de datos de ORFEO
$usuario = "orfeousr";                    // Usuario de conexion
$contrasena= "Cae,secoh7le";           // Contraseña
$db = $servicio;
$assoc = 1;   	// Identifica si las columnas van en mayuscula o minuscula el 1 aplica para todos los driver menos para MariaDB
...
$cuenta_mail="soporte@gmail.com";      // Usuario de conexion
$contrasena_mail="--------";           //  Contrasena
