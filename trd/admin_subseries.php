...
//$detasub = strtoupper(trim($detasub));
					  ...
					  ";
					    ...
					    $mensaje_err = " <HR><center><B><FONT COLOR=RED>SE CREO CORRECTAMENTE LA SUBSERIE</FONT></B></center><HR>";
					}
                                        ?>
                                        <script language="javascript">
...
//Selecciono Grabar Cambios
			          ...
			          ";
								...
								";
                                    ...
                                    $soporte = '';
				    if($rsUp){
					$mensaje_err = "<HR><center><B><FONT COLOR=RED>SE MODIFICO LA SUBSERIE</FONT></B></center><HR>";								    }else{
 	                                   $mensaje_err = "<HR><center><B><FONT COLOR=RED>NO SE PUDO REALIAR LA ACTUALIZACIÓN VERIFIQUE</FONT></B></center><HR>";
				    }		
                                    ?>
                                    <script language="javascript">
                                        document.adm_subserie.elements['detasub'].value = '';
