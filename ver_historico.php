...
//        echo '------- $assoc ' . $assoc . ' ----- $radi_depe_radi ' . $radi_depe_radi . ' ------ $usuario_actual ' . $usuario_actual;
        if ($usuario_actual == '') {
        ...
        <table  width="100%" align="center" border="1" cellpadding="0" cellspacing="5" class="borde_tab" >
            ...
            $isql = "select $sqlFecha AS HIST_FECH1, a.depe_codi, a.usua_codi,a.RADI_NUME_RADI,a.hist_obse ,a.usua_codi_dest,a.usua_doc ,a.hist_obse,a.sgd_ttr_codigo
		 from hist_eventos a where a.radi_nume_radi ='$verrad' order by hist_fech desc ";

            $i = 1;
            $rs = $db->query($isql);

//            error_log('-------------------xxxxx ' . $verrad. ' -----zzzzz '.$assoc);
            IF ($rs) {
                while (!$rs->EOF) {
                    $usua_doc_dest = "";
                    $usua_doc_hist = "";
...
//        echo '------------------> $isql ' . $isql;
        ...
        <table width="100%"  align="center" border="1" cellpadding="0" cellspacing="5" class="borde_tab" >
            <tr  align="center">
                ...
                <td  width=15% class="titulos3" height="24" >Tipo de env&iacute;o</td>
                <td  width=5% height="24" class="titulos3"> No. planilla</td>
                <td  width=5% height="24" class="titulos3"> No. Gu&iacute;a</td>
